...
/**
 * Adapted from core util module of Node.js (http://nodejs.org/)
 * See original at https://github.com/joyent/node/blob/master/lib/util.js
 */
 ...
 */
function inspect(obj, depth, _depth) {
  if(typeof(depth) !== 'number' && _depth) depth = _depth;
  var ctx = {
    showHidden: false,
    seen: [],
    stylize: stylize
  };
  return "\n"+formatValue(ctx, obj, (typeof depth === 'undefined' ? 2 : depth)).replace(/\n\n/g,"\n");
}
